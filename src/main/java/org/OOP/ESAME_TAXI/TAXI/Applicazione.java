...
public class Applicazione {
    ...
    private boolean campiNonNulli() {
        return registroCorse != null && registroGuidatori != null && registroPasseggeri != null && registroTaxi!=null && taxiBuilder != null && taxiFactory != null;
    }

    /**
     * Crea un nuovo guidatore a partire dai dati forniti. (Creator).
     * @param nome Nome del guidatore (REQUIRED)
     * @param cognome ognome del guidatore (REQUIRED)
